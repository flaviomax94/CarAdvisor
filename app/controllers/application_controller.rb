...
def controlloScadenze
  ...
  @scadenze.where(notificato: 'f').find_each do |scadenze|
	...
	if(scadenze.tipo =="Assicurazione")
		...
		elsif(scadenze.data_scadenza-5<get_data().mjd || (data_creazione+(365*3))-5<get_data().mjd)
	...
	km_medi_giorno=autoveicolo.media
        ...
        elsif(scadenze.data_scadenza-5<get_data().mjd || (data_creazione+360)<get_data().mjd)
